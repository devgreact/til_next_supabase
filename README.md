...
- `/src/hooks/muations/comment 폴더` 생성
- `/src/hooks/muations/comment/useCreateComment.ts 파일` 생성
...
- `/src/app/(protected)/post/[id]/page.tsx` type Props 추가
...
- `/src/hooks/mutations/comment/useDeleteComment.ts`
...
- `/src/hooks/mutations/useCreateComment.ts` 업데이트
...
- `/src/hooks/mutations/useUpdateComment.ts` 업데이트
...
- `/src/hooks/mutations/useDeleteComment.ts` 업데이트
